...
<div class="site-content">
    <main>
        ...
        <section class="signez" id="signez">
            ...
            <p class="signez__paragraph">N'hésitez pas à commenter ou à poser vos questions, le dialogue est toujours constructif.</p>
            <div class="signez__comwrap"><span class="signez__comwrap__title">2 commentaires</span>
                <div class="comment"><span class="signez__comwrap__namedate">Jérémy Deco
                <time>Il y a deux jours</time></span>
                    <p class="signez__comwrap__commentaire">Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression. Le Lorem Ipsum est le faux texte standard de l'imprimerie depuis les années 1500 quand un peintre anonyme assembla ensemble des morceaux de texte pour réaliser un livre spécimen de polices</p><a class="signez__comwrap__response" href="#">Répondre</a>
                </div>
                <div class="comment"><span class="signez__comwrap__namedate">Joséphine Ange-Gardien
                <time>Il y a trois jours</time></span>
                    <p class="signez__comwrap__commentaire">Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression.</p><a class="signez__comwrap__response" href="#">Répondre</a>
                </div>
                <div class="comment"><span class="signez__comwrap__namedate">Joséphine Ange-Gardien
                <time>Il y a trois jours</time></span>
                    <p class="signez__comwrap__commentaire">Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression.</p><a class="signez__comwrap__response" href="#">Répondre</a>
